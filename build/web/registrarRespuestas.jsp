    ...
    <body>
        <div class="form">
            ...
            <form method="post" action="Formulario" onsubmit="return validar()" >
                ...
                <input type="text" class="form-control" id="mascota" name="textIdMascota" value="<%=masVO.getIdMascota()%>" >
                <%}%>
                ...
                <div class="form-group col-md-15">
                    ...
                    %>
                    <input type="hidden" class="form-control" id="idf" name="textIdFormulario">
                    <input type="hidden" class="form-control" id="rol" name="textIdUsuario" value="<%=rolVO.getRolId()%>">

                </div>
                <div class="form-group col-md-15">
                    <label for="inputEmail4">¿Qué crees que la mascota le va a aportar a la familia?</label> <br>
                    <input type="text" class="form-control" id="p1" name="textP1">
                </div>
                ...
                <div class="form-group col-md-15">
                    ...
                    <input type="text" class="form-control" id="p2"  name="textP2">
                </div>

                <div class="form-group col-md-15">
                    <label for="inputEmail4">¿Estas dispuesto a poner mallas de protección para evitar accidentes?</label> <br>
                  
                      <select type="text" class="form-controll" id="p3" name="textP3" >
                ...
                <div class="form-group col-md-15">
                    ...
                    <select type="text" class="form-controll" id="p8" name="textP8" >
                        <option value="Selecciona..">Selecciona..</option>
                ...
                <div class="form-group col-md-15">
                    ...
                    <select type="text" class="form-controll" id="p9" name="textP9" >
                        <option value="Selecciona..">Selecciona..</option>
                        <option>Si se puede</option>
                        <option>No se puede</option>
                ...
                <div class="form-group col-md-15">
                    <label for="inputEmail4">¿La mascota podría escaparse por algún lugar de la casa o podría caer del balcón?</label> <br>
                     ...
                     <select type="text" class="form-controll" id="p10" name="textP10" >
                        <option value="Selecciona..">Selecciona..</option>
                        <option>Si</option>
                        <option>No</option>
                    </select>
                ...
                <input type="hidden" class="form-control" id="estado"  name="textEstadoFormulario"> 
                <input type="hidden" class="form-control" id="fecha"  name="textFechaRegistro">
        ...
        <div id="modalTerminos" class="modal">
            <div class="contenidoModal">
                ...
                <p class="pModal" >Que diligenciar este formulario no siginifica que me entregaran la mascota en adopción y que la información que he proporcionado será estudiada teniendo en cuenta la personalidad y las condiciones de la mascota en la que estoy interesado(a).
                    Manifiesto que mis intenciones de tener una mascota de compañia han sido meditadas y es una decisión que he tomado a conciencia y de forma racional, cuento con el tiempo, el dinero y el amor que implica tener una mascota, por lo tanto cumpliré con las condiciones de tenencia y protección animal.
                    En caso de recibir la mascota y no poder tenerlo en un futuro le informare al refugio para entregárselo y/o conjuntamente llegar a un acuerdo sobre el futuro de la mascota.
                    Me comprometo a no maltratar a la mascota, a darle comida de buena calidad y suficiente, no amarrarlo, no dejarlo a la intemperie, al sol, al frio y/o sin techo, si debo viajar lo dejaré con alguien de confianza.
        ...
        <br>
        <script src="js/validacionFormu.js" type="text/javascript"></script>
