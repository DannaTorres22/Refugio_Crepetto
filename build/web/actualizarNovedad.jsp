                                    ...
                                    <div class="table align-items-center mb-0">
                                        ...
                                        <div class="form" >
                                            <div class="container-fluid py-4">
                                                ...
                                                <div class="row"> <h1>Actualizar Novedad</h1>
                                                    <br></div>
                                                    ...
                                                    <table class="table align-items-center mb-0">
                                                        <tr>
                                                            <th>
                                                                ...
                                                                <input type="text" name="textIdMascota" class="form-controll" value="<%=novVO.getIdMascota()%>"><br><br>
                                                                Nombre de la novedad<br>
                                                                <input type="text" name="textTipoNovedad" class="form-controll" value="<%=novVO.getTipoNovedad()%>"><br><br>
                                                                Descripción<br>
                                                                <input type="text" id="raza" class="form-controll"  name="textObservacionNovedad" value="<%=novVO.getObservacionNovedad()%>">
