                                        ...
                                        <div class="container-fluid py-4">
                                            ...
                                            <form method="post" action="Formulario" onsubmit="return validar()" >
                                                ...
                                                <div class="form-group col-md-15">
                                                    <label for="inputEmail4">Usuario</label> <br>
                                                    <input type="text" class="form-controll" id="nombreN" name="textIdUsuario" value="<%=formVO.getIdUsuario()%>">
                                                </div>

                                                <div class="form-group col-md-15">
                                                    <label for="inputEmail4">Mascota</label> <br>
                                                    <input type="text" class="form-controll" id="nombreN" name="textIdMascota" value="<%=formVO.getIdMascota()%>" >
                                                </div>

                                                <div class="form-group col-md-15">
                                                    <label for="inputEmail4">¿Qué crees que la mascota le va a aportar a la familia?</label> <br>
                                                    <input type="text" class="form-controll" id="nombreN" name="textP1"value="<%=formVO.getP1()%>">
                                                </div>
                                                ...
                                                <div class="form-group col-md-15">
                                                    ...
                                                    <input type="text" class="form-controll" id="descripcion"  name="textP2"value="<%=formVO.getP2()%>">
                                                </div>

                                                <div class="form-group col-md-15">
                                                    <label for="inputEmail4">¿Estas dispuesto a poner mayas de protección para evitar accidentes?</label> <br>
                                                    <input type="text" class="form-controll" id="descripcion"  name="textP3"value="<%=formVO.getP3()%>">
                                                </div>
                                                ...
                                                <div class="form-group col-md-15">
                                                    ...
                                                    <input type="text" class="form-controll" id="descripcion" name="textP4" value="<%=formVO.getP4()%>">
                                                </div>

                                                <div class="form-group col-md-15">
                                                    <label for="inputEmail4">¿Qué lugar de tu casa tendrias destinado para la mascota?, ¿En dónde dormiría?</label> <br>
                                                    <input type="text" class="form-controll" id="descripcion"  name="textP5" value="<%=formVO.getP5()%>">
                                                </div>

                                                <div class="form-group col-md-15">
                                                    <label for="inputEmail4">¿Con cuanto tiempo dispones para la mascota por día?</label> <br>
                                                    <input type="text" class="form-controll" id="descripcion"  name="textP6" value="<%=formVO.getP6()%>">
                                                </div>

                                                <div class="form-group col-md-15">
                                                    <label for="inputEmail4">¿Vives en casa o apartamento?</label> <br>
                                                    <input type="text" class="form-controll" id="descripcion"  name="textP7" value="<%=formVO.getP7()%>">
                                                </div>

                                                <div class="form-group col-md-15">
                                                    <label for="inputEmail4">¿Tu vivienda es propia o en arriendo?</label> <br>
                                                    <input type="text" class="form-controll" id="descripcion"  name="textP8" value="<%=formVO.getP8()%>">
                                                </div>
                                                ...
                                                <div class="form-group col-md-15">
                                                    ...
                                                    <input type="text" class="form-controll" id="descripcion"  name="textP9" value="<%=formVO.getP9()%>">
                                                </div>

                                                <div class="form-group col-md-15">
                                                    <label for="inputEmail4">¿La mascota podría escaparse por algún lugar de la casa o podría caer del balcón?</label> <br>
                                                    <input type="text" class="form-controll" id="descripcion"  name="textP10" value="<%=formVO.getP10()%>">
                                                </div>
                                                <div class="form-group col-md-15">
                                                ...
                                                <div class="form-group col-md-15">
                                                    ...
                                                    <input type="text" class="form-controll" id="descripcion"  name="textFechaRegistro" value="<%=formVO.getFechaRegistro()%>">
                                                </div>
