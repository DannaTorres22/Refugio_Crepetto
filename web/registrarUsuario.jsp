                                ...
                                <form class="signin-form" method="post" action="Usuario" onsubmit="return validar()">
                                    <div class="text w-100">
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"id="nombre" class="form-control" name="textNombre" placeholder="Ingresa tu nombre"
                                                      >
                                            </div>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label class="label" for="name">Dirección</label>
                                            <input type="text" id="direccion" name="textDireccion" class="form-control" placeholder="Ingresa tu dirección"
                                                   >
                                        </div>
                                        <div class="form-group mb-3">
                                            <label class="label" for="name">Fecha de nacimiento</label>
                                            <input type="date" class="form-control" id="fecha"
                                                   placeholder="Ingresa tu fecha de nacimiento" name="textFechaNacimiento" >
                                        </div>
                                        <div class="form-group mb-3">
                                            <label class="label" for="name">Correo electronico</label>
                                            <input type="email" id="correo" name="textCorreoUsuario" class="form-control" placeholder="Ingresa tu correo"
                                                   >
                                        </div>
                                    </div>
                                    ...
                                    <div class="text w-100 ">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="apellido" class="form-control" name="textApellido" placeholder="Ingresa tu apellido"
                                                   >
                                        </div>
                                        <div class="form-group mb-3">
                                            <label class="label" for="password">Número celular</label>
                                            <input type="number" id="numero" name="textCelular" class="form-control" placeholder="Ingresa tu celular"
                                                   >
                                        </div>
                                        ...
                                        <div class="form-group mb-3 dosInput">
                                            ...
                                            <select name="textTipoDocumento"id="tipo" class="form-control select">
                                            ...
                                            <input type="text" id="numerod" name="textNumDocumento" class="form-control" placeholder="Identificación" >
                                        </div>


                                        <div class="form-group mb-3">
                                            <label class="label" for="name">Contraseña</label>
                                            <input id="password" type="password" name="textPassword" class="form-control" placeholder="Ingresa una contraseña"
                                                   >
                                        </div>
